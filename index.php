...
<body>
            ...
            <div class="slider-content d-flex flex-center">
                ...
                <div class="col-md-4 hidden-sm hidden-xs">
                    <div class="slider-m-img">
                        <img src="assets/img/ab-trivia-screen1.png" alt="The answer is Cabbage Patch Kids, in case you were wondering">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="screen-slider-area ptb--120" id="categories">
        <div class="container">
